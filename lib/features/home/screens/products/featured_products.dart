...
class FeaturedProducts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    productController.setFeaturedProducts(
        'Name', productController.allFeaturedProducts);
    //
        ...
        children: [
                  ...
                  () => ButtonTheme(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                        ...
                        isExpanded: true,
                        value:
                            productController.selectedFeaturedSortOption.value,
                        items: <String>[
                          'Name',
                          'Low to High',
                          'High to Low',
                        ...
                        onChanged: (String? value) {
                          productController.setFeaturedProducts(
                            value!,
                            productController.allFeaturedProducts,
                          );
                        },
          ...
          Obx(
            () {
              ...
              if (productController.allFeaturedProducts.isEmpty) {
              ...
              return Expanded(
                child: GridView.builder(
                  ...
                  itemCount: productController.allFeaturedProducts.length,
                  itemBuilder: (context, index) {
                    // category
                    final product =
                        productController.allFeaturedProducts[index];
